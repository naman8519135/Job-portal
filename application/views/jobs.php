...
<style>
	...
	.single-res{}
	.p0 {padding:0}
	.job-icon{margin: 8px 0;width: 50px;height: 50px;background: #ff8a65;color: #fff;font-size: 180%;text-align: center;padding: 2px 3px;text-shadow: 1px 1px 1px #737373;}
		...
		//			alert(res.length);
					...
					for(var i=0;i<res.length;i++)
					{
						...
						$('.results').append(							
							...
							"					<div class='p0 job-salary col-xs-12 col-sm-6 col-md-4 col-lg-3'><i class='fa1 fa fa-dollar'></i>"+res[i].salary_min+" - "+res[i].salary_max+"</div>"+
	...
	$(document).ready(function(){
		...
		$(function() {
			$( "#slider-range" ).slider({
				...
				$(".sliderange").html("<i class='fa fa-dollar'></i> "+ui.values[ 0 ]+" - <i class='fa fa-dollar'></i> "+ui.values[ 1 ]);
				get_result();
				}
			});
			$( "#salary_min" ).val($( "#slider-range" ).slider( "values", 0 ));
			$( "#salary_max" ).val($( "#slider-range" ).slider( "values", 1 ) );
			$(".sliderange").html("<i class='fa fa-dollar'></i> "+$( "#slider-range" ).slider( "values", 0 )+" - <i class='fa fa-dollar'></i> "+$( "#slider-range" ).slider( "values", 1 ));
		});
