...
<section class="home">
	<div class="main_div">
		<p class='heading_p'>	Reduce unemployment and use the skills for employment!</p>
		

		<div class="container nav_btn1">
			<a href="<?=base_url()?>jobs"><button class="job-btn">FIND SUITABLE JOB</button></a>
			<a href="<?=base_url()?>post_job"><button class="job-btn">POST NEW JOBS</button></a>
		</div>	
	</div>	
</section>