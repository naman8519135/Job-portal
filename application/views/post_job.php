		...
		<div class="form">
			...
			<form class="post_job" name="post_job" id="post_job" method='post' action='<?php echo base_url();?>post_job/submit'>
				...
				<div class="form-group row">
					...
					<textarea rows='3' name='description' id='description' class='form-control' placeholder="Enter job's description" ><?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>","\n"), array("","","","","\n"), $edit->description));?><?php } ?></textarea>
				</div>
				
				<div class="form-group row">
					<p style='text-align:left;color: #e78217;font-size: 16px;'>Responsibilities:</p>
					<textarea rows='3' name='responsibilities' id='responsibilities' class='form-control' placeholder="Enter all the responsibilities for the job"><?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>","\n"), array("","","","","\n"), $edit->responsibilities));?><?php } ?></textarea>
				</div>
				
				<div class="form-group row">
					<p style='text-align:left;color: #e78217;font-size: 16px;'>Skills Required:</p>
					<textarea rows='3' name='skills' id='skills' class='form-control'  placeholder="List out requirements for the job"><?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>","\n"), array("","","","","\n"), $edit->skills));?><?php } ?></textarea>
				</div>
				
				<div class="form-group row">
					<p style='text-align:left;color: #e78217;font-size: 16px;'>Benefits:</p>
					<textarea rows='3' name='perks' id='perks' class='form-control'  placeholder="Add benefits of working with the company/job"><?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>","\n"), array("","","","","\n"), $edit->perks));?><?php } ?></textarea>
				</div>

				<div class="form-group row">
					<p style='text-align:left;color: #e78217;font-size: 16px;'>Salary $(per annum):</p>
					<div class='col-sm-6' style='padding: 0;padding-right: 10px'><input type="number" name='salary_min' id='salary_min' class='form-control' placeholder="Minimum" value="<?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>"), array("","","",""), $edit->salary_min));?><?php } ?>"/></div>
				...
				<div class="form-group row">
					<p style='text-align:left;color: #e78217;font-size: 16px;'>Contact Email:</p>
					<input type="email" name='contact_email' id='contact_email' class='form-control' placeholder="Enter company's email"  value="<?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>"), array("","","",""), $edit->contact_email));?><?php } ?>"/>
				</div>
				
				<div class="form-group row">
					<p style='text-align:left;color: #e78217;font-size: 16px;'>Expiry Date</p>
					<input type="text" name='expires' id='expires' class='datepicker form-control' placeholder="Expiry Date for Vacancy"  value="<?php if($this->uri->segment(2)=='edit'){ ?><?php  echo strip_tags(str_replace(array("<ul class='bullets'>","</ul>","<li>","</li>"), array("","","",""), $edit->expires));?><?php } ?>"/> 
				</div>
				...
				<button type='submit' id='submit_job'>POST JOB VACANCY</button>
				<?php } ?>
