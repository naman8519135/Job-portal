...
<style>
	...
	.p0 {padding:0}
	.job-icon{margin: 8px 0;width: 50px;height: 50px;background: #ff8a65;color: #fff;font-size: 200%;text-align: center;padding: 2px 3px;text-shadow: 1px 1px 1px #737373;}
		...
		<div class='job-section  col-sm-10 col-md-10 col-lg-10'>
					...
					<div class='col-sm-10 col-lg-11'>
						<div>
							...
							<div class='p0 col-sm-12 col-md-12'>
								...
								<div class='p0 job-salary col-sm-5 col-md-9 col-lg-10'><i class='fa1 fa fa-dollar'></i><?=$salary_min?> - <?=$salary_max?></div>
			...
			<div class='row'>
				...
				<div class='col-sm-11 col-lg-11'>
					<div class='new-point' style="text-decoration:none;">Job Description:</div>
					<div class='job-description'><?=$description?></div>
					<div class='new-point' style="text-decoration:none;">Job Responsibilities:</div>
					<div class='pre-wrap job-responsibilities'><?=$responsibilities?></div>
					<div class='new-point' style="text-decoration:none;">Skills & Expertise :</div>
					<div class='pre-wrap job-skills'><?=$skills?></div>
					<div class='new-point' style="text-decoration:none;">Benefits:</div>
					<div class='pre-wrap job-perks'><?=$perks?></div>
					<div class='new-point' style="text-decoration:none;">Contact Email:</div>
					<div class='job-description'><i class='fa1 fa fa-envelope '></i> <?=$contact_email?></div>
				</div>
			</div>
