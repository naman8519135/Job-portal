...
class Post_job extends CI_Controller 
{
	...
	function index()
	{
		...
		{
			$data['tab'] = 'POST JOB';
			$data['location'] = array('New York','San Francisco','Chicago','Los Angles','Boston','Seattle','Austin','San Diego','Washington','Detroit','Dallas','Houston','Miami','Atlanta','Nashville');
			sort($data['location']);
